...
{
    [TestFixture]
    public class NullableUnsignedLongDatumConverterTests
    {
        [Test]
        ...
        {
            PrimitiveDatumConverterFactory.Instance.Get<ulong?>().ConvertDatum(new RethinkDb.Spec.Datum(){type = RethinkDb.Spec.Datum.DatumType.R_NUM, r_num = (double)ulong.MinValue - 1.0});
        }
